...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Accuracy over epoch - ResNet 18")
plt.legend()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Loss over epoch - ResNet 18")
plt.legend()
...
class MyGoogleNet(nn.Module):
  def __init__(self):
    super().__init__()
    self.pretrained = torchvision.models.googlenet(pretrained=True)
    self.new_linear = nn.Linear(1000, 4)
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Accuracy over epoch - GoogleNet")
plt.legend()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Loss over epoch - GoogleNet")
plt.legend()
...
class MyDenseNet(nn.Module):
  def __init__(self):
    super().__init__()
    self.pretrained = torchvision.models.densenet161(pretrained=True)
    self.new_linear = nn.Linear(1000, 4)
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Accuracy over epoch - DenseNet")
plt.legend()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Loss over epoch - DenseNet")
plt.legend()


## TEST
# Model is MobileNet v3 large
...
plt.xlabel("Epoch")
plt.ylabel("Accuracy")
plt.title("Accuracy over epoch - MobileNet")
plt.legend()
...
plt.xlabel("Epoch")
plt.ylabel("Loss")
plt.title("Loss over epoch - MobileNet")
plt.legend()
